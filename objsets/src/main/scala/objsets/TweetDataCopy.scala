...
{ "user": "TechCrunch", "text": "Adobe's Acrobat Android XI Boasts New PDF Editor And Touch-Friendly Interface ? Upgrades Start At $139 http://t.co/1YDWvlVI by @anthonyha", "retweets": 26.0 }
]"""
  val engadget = """[
...
{ "user": "engadget", "text": "HP announces Android the ElitePad 900, a business-friendly Windows 8 tablet arriving in January -  http://t.co/RjSj2cms", "retweets": 33.0 }
]"""
  val amazondeals = """[
